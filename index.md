...
<center> <img src="assets/Screenshot (3).png" width="900" height="300" /> </center>

The **Super Store Sales Dashboard in Power BI** provides a comprehensive analysis of sales performance, profitability, and customer trends across various regions, product categories, and customer segments. This interactive dashboard enables businesses to track key metrics, identify sales patterns, and forecast future trends using **time series analysis**. With dynamic visualizations and data-driven insights, the project enhances decision-making, helping organizations optimize sales strategies and improve overall performance. 

[![View on GitHub](https://img.shields.io/badge/GitHub-View_on_GitHub-blue?logo=GitHub)](https://github.com/AchleshwarSingh/SuperStore-Sales-Dashboard---Power-BI)

### Ecom Sales Data Dashboard
<center> <img src="assets/img/Sales Ecom Dashboard.png" width="900" height="300" /> </center>

Developed an **interactive Power BI dashboard** to track and analyze online sales data, incorporating complex parameters for drill-down analysis and customization using filters and slicers. Established connections, joined new tables, and performed calculations to manipulate data, enabling user-driven visualizations. Designed a variety of customized visualizations, including bar charts, pie charts, donut charts, clustered bar charts, scatter plots, line charts, area charts, maps, and slicers, to provide in-depth insights and enhance data exploration.

[![View on GitHub](https://img.shields.io/badge/GitHub-View_on_GitHub-blue?logo=GitHub)](https://github.com/AchleshwarSingh/Ecom-Sales-Data-Dashboard/tree/main)
